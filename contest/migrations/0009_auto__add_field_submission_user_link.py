...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.user_link'
        db.add_column('contest_submission', 'user_link',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.user_link'
        db.delete_column('contest_submission', 'user_link')
    ...
    models = {
        ...
        'contest.submission': {
            ...
            'user_link': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
