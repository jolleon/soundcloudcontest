...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contest.date_last_modified'
        db.add_column('contest_contest', 'date_last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 6, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contest.date_last_modified'
        db.delete_column('contest_contest', 'date_last_modified')
