...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.username'
        db.add_column('contest_submission', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Submission.track_id'
        db.add_column('contest_submission', 'track_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Submission.user_id'
        db.add_column('contest_submission', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Submission.title'
        db.add_column('contest_submission', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Submission.uri'
        db.add_column('contest_submission', 'uri',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.username'
        db.delete_column('contest_submission', 'username')

        # Deleting field 'Submission.track_id'
        db.delete_column('contest_submission', 'track_id')

        # Deleting field 'Submission.user_id'
        db.delete_column('contest_submission', 'user_id')

        # Deleting field 'Submission.title'
        db.delete_column('contest_submission', 'title')

        # Deleting field 'Submission.uri'
        db.delete_column('contest_submission', 'uri')
    ...
    models = {
        ...
        'contest.submission': {
            ...
            'track_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
