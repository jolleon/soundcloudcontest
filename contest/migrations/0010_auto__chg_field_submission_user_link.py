...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.user_link'
        db.alter_column('contest_submission', 'user_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Submission.user_link'
        db.alter_column('contest_submission', 'user_link', self.gf('django.db.models.fields.IntegerField')(null=True))
