...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contest_submission', 'contest',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['contest.Contest']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.contest'
        db.delete_column('contest_submission', 'contest_id')
